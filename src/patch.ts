 ...
 * in its closure so that the mount used while doing re-mounts will already have
 * access to the same `eventHandlerWrapper` created on app start.
 *
...
export const patchFF = (
   ...
   * reconcile the 2 and apply the differences to the real DOM.
   */
  function patch(originalVNode: VNode, newVNode: VNode) {
